...
const float Control_Unit[18][20]=
{
  ...
  //好盈乐天20A默认固件F330
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 80,   4.00   ,0.0000  ,0.00  ,0  ,0 , 600,  1 ,  1 ,  1 },//Pitch_Angle;偏航角度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,600 ,0  ,0 , 300,  0.72   ,3.0000  ,2.40  ,0  ,0 , 500,  1 ,  1 ,  1 },//Pitch_Gyro;偏航角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 80,   4.00   ,0.0000  ,0.00  ,0  ,0 , 600,  1 ,  1 ,  1 },//Roll_Angle;横滚角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,600 ,0  ,0 , 300,  0.72   ,3.0000  ,2.40  ,0  ,0 , 500,  1 ,  1 ,  1 },//Roll_Gyro;横滚角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,45  ,0  ,0 , 150 , 4.00   ,0.0000  ,0.00  ,0  ,0 , 300,  1 ,  1 ,  1 },//Yaw_Angle;偏航角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,300 ,0  ,0 , 200,  1.40   ,0.0000  ,0.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Yaw_Gyro;偏航角速度   
/*
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 80,   3.00   ,0.0000  ,0.00  ,0  ,0 , 600,  1 ,  1 ,  1 },//Pitch_Angle;偏航角度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,600 ,0  ,0 , 300,  0.65   ,3.0000  ,2.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Pitch_Gyro;偏航角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 80,   3.00   ,0.0000  ,0.00  ,0  ,0 , 600,  1 ,  1 ,  1 },//Roll_Angle;横滚角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,600 ,0  ,0 , 300,  0.65   ,3.0000  ,2.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Roll_Gyro;横滚角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,45  ,0  ,0 , 150 , 3.50   ,0.0000  ,0.00  ,0  ,0 , 300,  1 ,  1 ,  1 },//Yaw_Angle;偏航角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,300 ,0  ,0 , 200,  1.00   ,0.0000  ,0.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Yaw_Gyro;偏航角速度    
*/ 
  ...
  //{1  ,1 ,0 ,0 ,0 ,0 , 0 ,400 ,0  ,0 ,500 ,  3.0     ,0.000   ,0  ,0  ,0 ,500,  1 ,  1 ,  1 },//High_Speed;海拔攀升速度
	{1  ,1 ,0 ,0 ,0 ,0 , 0 ,200 ,0  ,0 ,100 ,  0.15     ,0.000   ,0    ,0  ,0 ,400,  1 ,  1 ,  1 },//High_Position;海拔高度位置
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,400 ,0  ,0 ,500 ,  3.0     ,0.000   ,0  ,0  ,0 ,500,  1 ,  1 ,  1 },//High_Speed;海拔攀升速度
#endif
  /*
  1偏差限幅标志；  2积分限幅标志；3积分分离标志；    4期望；
  ...
  */
  ...
  /*************加速度控制器****************/
  //期望最大加速度500cm/s^2
	//{1  ,1 ,0 ,0 ,0 ,0 , 0 ,600  ,0  ,0 ,500,0.10    ,0.8000    ,0.0  ,0   ,0 ,600,  1 ,  1 ,  1 },//垂直加速度控制器	
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,1000  ,0  ,0 ,750,0.20    ,1.5000    ,0.0  ,0   ,0 ,1000,  1 ,  1 ,  1 },//垂直加速度控制器
  ...
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30    ,30  ,0 ,10,  2.50   ,0     ,150.0  ,0    ,0 ,500  , 1 ,  1 ,  1 },//水平维度方向加速度控制器
};
...
void Total_PID_Init(void)
{
  ...
  Set_Cutoff_Frequency(Sampling_Freq, 30,&Control_Device_Div_LPF_Parameter_For_Gyro);
}
...
float PID_Control_Div_LPF_For_Gyro(PID_Controler *Controler)
{
  ...
  Controler->Adaptable_Kd=Controler->Kd*(1+Controler->Dis_Error_History[0]/500);//自适应微分参数
...
void PID_Paramter_Init_With_Flash()
{
  ...
  {
    PID_Parameter_Read_Flag.No_0xFF[i]=ReadFlashParameterThree(PID1_PARAMETER_KP+3*i,
                                                               &PID_Parameter[i].p,
                                                               &PID_Parameter[i].i,
                                                               &PID_Parameter[i].d);
  }
