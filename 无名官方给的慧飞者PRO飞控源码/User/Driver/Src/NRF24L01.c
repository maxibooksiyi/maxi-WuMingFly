  ...
  ***************************************************************/
  ...
  if(Throttle_Control==1000
     &&Yaw_Control>=Yaw_Max*Scale_Pecent_Max
       &&Roll_Control==0
         &&Pitch_Control==0
           &&(Unlock_Makesure_Cnt>200*1.0//持续1.0S
              ||Forced_Lock_Makesure_Cnt>=200*5))
  {
    ...
    Bling_Set(&Light_1,3000,200,0.5,0,GPIOC,GPIO_Pin_6,0);
    Bling_Set(&Light_2,3000,200,0.5,0,GPIOC,GPIO_Pin_7,0);
  ...
  if(Throttle_Control==1000
     &&Yaw_Control<=-Yaw_Max*Scale_Pecent_Max
       &&Roll_Control==0
         &&Pitch_Control==0
           &&Lock_Makesure_Cnt>200*1.0//持续1.0S
             &&Check_Calibration_Flag()==0x00)
  {
    ...
    Unlock_Makesure_Cnt=0;
    Forced_Lock_Makesure_Cnt=0;
    Bling_Set(&Light_1,5000,2000,0.9,0,GPIOC,GPIO_Pin_6,0);
    Bling_Set(&Light_2,5000,2000,0.5,0,GPIOC,GPIO_Pin_7,0);
    Bling_Set(&Light_3,5000,2000,0.1,0,GPIOC,GPIO_Pin_8,0);
    Bling_Mode=0;
    Page_Number=0;//OLED恢复首页
    Reset_Mag_Calibartion(1);
    Reset_Accel_Calibartion(1);
  ...
  if(Auto_Relock_Flag==1)
  {
          ...
          &&Unwanted_Lock_Flag==0)
    {
      ...
      Auto_ReLock_Cnt=0;
      Bling_Set(&Light_1,5000,2000,0.3,0,GPIOC,GPIO_Pin_6,0);
      Bling_Set(&Light_2,5000,2000,0.3,0,GPIOC,GPIO_Pin_7,0);
      Bling_Set(&Light_3,5000,2000,0.3,0,GPIOC,GPIO_Pin_8,0);
      Bling_Mode=0;
    }
  }
}
